...
If ($Team == 0){
	...
	If ($Result['count'] == 1){
		...
		$Query = "Select Name, PointSystemSO, LeagueYearOutput, ProInjuryRecoverySpeed, FarmInjuryRecoverySpeed, ProScheduleTotalDay, ScheduleNextDay, DraftPickByYear, DefaultSimulationPerDay from LeagueGeneral";
