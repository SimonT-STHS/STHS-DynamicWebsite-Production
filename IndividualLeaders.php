...
<?php
$Query = "SELECT Goaler" . $TypeText . "Stat.SecondPlay, Goaler" . $TypeText . "Stat.GP, Goaler" . $TypeText . "Stat.SecondPlay, Goaler" . $TypeText . "Stat.Name, GoalerInfo.NHLID, Goaler" . $TypeText . "Stat.Number, Team" . $TypeText . "Info.Abbre, Team" . $TypeText . "Info.TeamThemeID FROM (GoalerInfo INNER JOIN Goaler" . $TypeText . "Stat ON GoalerInfo.Number = Goaler" . $TypeText . "Stat.Number) LEFT JOIN Team" . $TypeText . "Info ON GoalerInfo.Team = Team" . $TypeText . "Info.Number WHERE (Goaler" . $TypeText . "Stat.SecondPlay >= (" . $MinimumGamePlayer . "*3600)) AND (GoalerInfo.Team > 0) AND (Goaler" . $TypeText . "Stat.SecondPlay > 0) ORDER BY Goaler" . $TypeText . "Stat.SecondPlay DESC, Goaler" . $TypeText . "Stat.GP ASC";
If ($MaximumResult > 0){$Query = $Query . " LIMIT " . $MaximumResult;}
If ($Title == $DatabaseNotFound){$GoalerStat = Null;}else{$GoalerStat = $db->query($Query);}
$LoopCount = (integer)0;
if (empty($GoalerStat) == false){while ($Row = $GoalerStat ->fetchArray()) {
...
<?php
$Query = "SELECT Goaler" . $TypeText . "Stat.SA, Goaler" . $TypeText . "Stat.GP, Goaler" . $TypeText . "Stat.SecondPlay, Goaler" . $TypeText . "Stat.Name, GoalerInfo.NHLID, Goaler" . $TypeText . "Stat.Number, Team" . $TypeText . "Info.Abbre, Team" . $TypeText . "Info.TeamThemeID FROM (GoalerInfo INNER JOIN Goaler" . $TypeText . "Stat ON GoalerInfo.Number = Goaler" . $TypeText . "Stat.Number) LEFT JOIN Team" . $TypeText . "Info ON GoalerInfo.Team = Team" . $TypeText . "Info.Number WHERE (Goaler" . $TypeText . "Stat.SecondPlay >= (" . $MinimumGamePlayer . "*3600)) AND (GoalerInfo.Team > 0) AND (Goaler" . $TypeText . "Stat.SA > 0) ORDER BY Goaler" . $TypeText . "Stat.SA DESC, Goaler" . $TypeText . "Stat.GP ASC";
If ($MaximumResult > 0){$Query = $Query . " LIMIT " . $MaximumResult;}
If ($Title == $DatabaseNotFound){$GoalerStat = Null;}else{$GoalerStat = $db->query($Query);}
$LoopCount = (integer)0;
if (empty($GoalerStat) == false){while ($Row = $GoalerStat ->fetchArray()) {
...
<?php
$Query = "SELECT Goaler" . $TypeText . "Stat.Shootout, Goaler" . $TypeText . "Stat.GP, Goaler" . $TypeText . "Stat.SecondPlay, Goaler" . $TypeText . "Stat.Name, GoalerInfo.NHLID, Goaler" . $TypeText . "Stat.Number, Team" . $TypeText . "Info.Abbre, Team" . $TypeText . "Info.TeamThemeID FROM (GoalerInfo INNER JOIN Goaler" . $TypeText . "Stat ON GoalerInfo.Number = Goaler" . $TypeText . "Stat.Number) LEFT JOIN Team" . $TypeText . "Info ON GoalerInfo.Team = Team" . $TypeText . "Info.Number WHERE (Goaler" . $TypeText . "Stat.SecondPlay >= (" . $MinimumGamePlayer . "*3600)) AND (GoalerInfo.Team > 0) AND (Goaler" . $TypeText . "Stat.Shootout > 0) ORDER BY Goaler" . $TypeText . "Stat.Shootout DESC, Goaler" . $TypeText . "Stat.GP ASC";
If ($MaximumResult > 0){$Query = $Query . " LIMIT " . $MaximumResult;}
If ($Title == $DatabaseNotFound){$GoalerStat = Null;}else{$GoalerStat = $db->query($Query);}
$LoopCount = (integer)0;
if (empty($GoalerStat) == false){while ($Row = $GoalerStat ->fetchArray()) {
...
<?php
$Query = "SELECT Goaler" . $TypeText . "Stat.W, Goaler" . $TypeText . "Stat.GP, Goaler" . $TypeText . "Stat.SecondPlay, Goaler" . $TypeText . "Stat.Name, GoalerInfo.NHLID, Goaler" . $TypeText . "Stat.Number, Team" . $TypeText . "Info.Abbre, Team" . $TypeText . "Info.TeamThemeID FROM (GoalerInfo INNER JOIN Goaler" . $TypeText . "Stat ON GoalerInfo.Number = Goaler" . $TypeText . "Stat.Number) LEFT JOIN Team" . $TypeText . "Info ON GoalerInfo.Team = Team" . $TypeText . "Info.Number WHERE (Goaler" . $TypeText . "Stat.SecondPlay >= (" . $MinimumGamePlayer . "*3600)) AND (GoalerInfo.Team > 0) AND (Goaler" . $TypeText . "Stat.W > 0) ORDER BY Goaler" . $TypeText . "Stat.W DESC, Goaler" . $TypeText . "Stat.GP ASC";
If ($MaximumResult > 0){$Query = $Query . " LIMIT " . $MaximumResult;}
If ($Title == $DatabaseNotFound){$GoalerStat = Null;}else{$GoalerStat = $db->query($Query);}
$LoopCount = (integer)0;
if (empty($GoalerStat) == false){while ($Row = $GoalerStat ->fetchArray()) {
...
<?php
$Query = "SELECT Goaler" . $TypeText . "Stat.L, Goaler" . $TypeText . "Stat.GP, Goaler" . $TypeText . "Stat.SecondPlay, Goaler" . $TypeText . "Stat.Name, GoalerInfo.NHLID, Goaler" . $TypeText . "Stat.Number, Team" . $TypeText . "Info.Abbre, Team" . $TypeText . "Info.TeamThemeID FROM (GoalerInfo INNER JOIN Goaler" . $TypeText . "Stat ON GoalerInfo.Number = Goaler" . $TypeText . "Stat.Number) LEFT JOIN Team" . $TypeText . "Info ON GoalerInfo.Team = Team" . $TypeText . "Info.Number WHERE (Goaler" . $TypeText . "Stat.SecondPlay >= (" . $MinimumGamePlayer . "*3600)) AND (GoalerInfo.Team > 0) AND (Goaler" . $TypeText . "Stat.L > 0) ORDER BY Goaler" . $TypeText . "Stat.L DESC, Goaler" . $TypeText . "Stat.GP ASC";
If ($MaximumResult > 0){$Query = $Query . " LIMIT " . $MaximumResult;}
If ($Title == $DatabaseNotFound){$GoalerStat = Null;}else{$GoalerStat = $db->query($Query);}
$LoopCount = (integer)0;
if (empty($GoalerStat) == false){while ($Row = $GoalerStat ->fetchArray()) {
