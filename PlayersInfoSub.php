<?php If (isset($PlayersLang) == False){include 'LanguageEN.php';} If (isset($Team) == False){$Team = (int)-1;} If (isset($FreeAgentYear) == False){$FreeAgentYear = (int)-1;} If (isset($LeagueOutputOption) == False){$LeagueOutputOption = Null;} If (isset($HistoryOutput) == False){$HistoryOutput = (bool)False;}?> 
