...
'ChangeNewPassword'		=> 'Changement User Password',
'IncorrectPassword'			=> 'Incorrect Current Password!',
'EditPasswordConfirm'		=> 'Password Edit Confirmed',
'Edit'		=> 'Edit',
...
'PasswordSecurityNote'		=> 'SECURITY NOTE: Because anyone can read the SQLite Database, your encrypt password can be stolen easily. Unencrypting your password is not an easy thing to do but it’s possible. So please do NOT choose a password you are using somewhere else on Internet (Especially not for your financial institution!). The STHS does NOT enforce password complexity or length.',
