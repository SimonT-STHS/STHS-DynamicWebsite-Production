...
If (file_exists($DatabaseFile) == false){
	...
	If($Year > 0 AND file_exists($CareerStatDatabaseFile) == true){  /* CareerStat */
		...
		$Query = "Select OutputSalariesRemaining, InchInsteadofCM, LBSInsteadofKG, FreeAgentUseDateInsteadofDay, FreeAgentRealDate from LeagueOutputOption";
		$LeagueOutputOption = $db->querySingle($Query,true);	
